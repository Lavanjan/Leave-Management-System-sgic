                        ...
                        <div class=" col-xl-3 col-lg-4 col-md-12 theiaStickySidebar">
                            <aside class="sidebar sidebar-user">
                                ...
                                <div class="quicklink-sidebar-menu ctm-border-radius shadow-sm bg-white card">
                                    <div class="card-body">
                                    <ul class="list-group">
                                                <li class="mr-1"><a class="btn-ctm-space btn-dec" href="/Profile_details"><span class="lnr lnr-user pr-0 pr-lg-2"></span><span class="d-none d-lg-inline">Profile</span></a></li>
                                                <li class="mr-1 active"><a class="btn-ctm-space text-white calen-btn" href="/Profile_Settings"><span class="lnr lnr-cog pr-0 pr-lg-2"></span><span class="d-none d-lg-inline">Settings</span></a></li>
                                            </ul>
                                    </div>
                                </div>
                            </aside>
